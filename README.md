...
| NF-κB signaling                         | Predominantly positive log2 fold-change                                    | Nominally significant probes mapped to genes within NF-κB–related signaling cascades; signals were modest in magnitude and distributed across probes                                          |
...
| Epithelial adhesion and barrier-related |                                                                            |                                                                                                                                                                                               |
| processes                               | Mixed directionality across probes                                         | Probes mapping to epithelial adhesion and barrier maintenance genes showed both positive and negative log2 fold-changes, with no consistent directional bias                                  |
